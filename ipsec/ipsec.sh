...
# ==================================================
# Link Hosting Kalian
akbarvpn="raw.githubusercontent.com/NiLphreakz/hop/main/ipsec"
...
if [[ ${OS} == "centos" ]]; then
epel_url="https://github.com/NiLphreakz/addons/releases/download/epelV9/epel-release-latest-9.noarch.rpm -E '%{rhel}').noarch.rpm"
...
swan_url1="https://github.com/NiLphreakz/addons/releases/download/libreswan-3.32/libreswan-3.32.tar.gz"
swan_url2="https://github.com/NiLphreakz/addons/releases/download/libreswan-3.32/libreswan-3.32.tar.gz"
